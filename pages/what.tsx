...
export default function What() {
  ...
  const { occasion, setOccasion } = useCreatePollContext();
    ...
    <Layout title="What's the occasion?">
      <form className="w-full" onSubmit={handleFormSubmission}>
        <textarea
          ...
          className="mb-4 p-3 outline-none appearance-none bg-black text-white w-full text-3xl italic sm:text-6xl border-0"
          value={occasion}
